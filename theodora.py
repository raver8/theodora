...
st.markdown("<h1 style='text-align: center;'>COMING SOON:<br>THEODORA, <br>THE AI-POWERED RISK MANAGEMENT PLATFORM</h1>", unsafe_allow_html=True)
...
if os.path.exists(image_path):
    ...
    st.image(image, caption='_', use_column_width=True)    
else:
